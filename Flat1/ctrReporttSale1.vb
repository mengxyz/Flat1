...
Public Class ctrReporttSale1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Flat1.ctrReporttSale1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedctrReporttSale1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ctrReporttSale1 = New ctrReporttSale1()
        rpt.Site = Me.Site
        Return rpt
    End Function
