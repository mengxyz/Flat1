...
Public Class ctrReportProductCate
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ctrReportProductCate.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Flat1.ctrReportProductCate.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Cate() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedctrReportProductCate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ctrReportProductCate = New ctrReportProductCate()
        rpt.Site = Me.Site
        Return rpt
    End Function
