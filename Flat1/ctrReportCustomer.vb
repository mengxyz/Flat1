...
Public Class ctrReportCustomer
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Flat1.ctrReportCustomer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedctrReportCustomer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ctrReportCustomer = New ctrReportCustomer()
        rpt.Site = Me.Site
        Return rpt
    End Function
