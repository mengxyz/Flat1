...
Public Class ctrReportProduct
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Flat1.ctrReportProduct.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedctrReportProduct
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ctrReportProduct = New ctrReportProduct()
        rpt.Site = Me.Site
        Return rpt
    End Function
